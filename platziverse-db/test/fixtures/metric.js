...
const metric = {
  id: 1,
  agentId: agentFixtures.single.uuid,
  type: 'CPU',
  value: '30%',
  createdAt: new Date(),
  updatedAt: new Date()
...
const metrics = [
  metric,
  extend(metric, {id: 2, agentId: agentFixtures.single.uuid, type: 'TEMP', value: '28'}),
  extend(metric, {id: 3, agentId: 'yyy-yyy-yyw'}),
  extend(metric, {id: 4, agentId: agentFixtures.single.uuid, type: 'TEMP', value: '25'})
]
